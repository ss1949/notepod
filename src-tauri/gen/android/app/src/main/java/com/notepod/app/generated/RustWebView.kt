...
/** 被 WebView JS 调用的状态栏桥接 */
class NotePodStatusBarBridge {
  @JavascriptInterface
  fun setStatusBarTheme(isDark: Boolean) {
    MainActivity.instance?.updateStatusBarStyle(isDark)
  }
}
...
class RustWebView(context: Context, val initScripts: Array<String>, val id: String): WebView(context) {
    ...
    init {
        ...
        // 注册 JS 桥接：NotePodBridge.setStatusBarTheme(bool)
        addJavascriptInterface(NotePodStatusBarBridge(), "NotePodBridge")
